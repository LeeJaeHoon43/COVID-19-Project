...
class EventControllerTest {
    ...
    void givenParams_whenRequestingCustomEventsPage_thenReturnsEventsPage() throws Exception {
        ...
        LocalDateTime eventStartDatetime = LocalDateTime.of(2022, 8, 1, 0, 0, 0);
        LocalDateTime eventEndDatetime = LocalDateTime.of(2022, 8, 1, 23, 0, 0);
    ...
    void givenWrongParams_whenRequestingCustomEventsPage_thenReturnsEventsPage() throws Exception {
        ...
        EventStatus eventStatus = EventStatus.OPENED;
        LocalDateTime eventStartDatetime = LocalDateTime.of(2022, 8, 1, 0, 0, 0);
        LocalDateTime eventEndDatetime = LocalDateTime.of(2022, 8, 2, 0, 0, 0);
        given(eventService.getEventViewResponse(
                placeName,
                eventName,
                eventStatus,
